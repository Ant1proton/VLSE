...
public class Main {
    ...
    /**
     * 计算密文集大小（字节），包括DictW和FileCnt两个数据结构
     */
    private static long calculateFullIndexSize(Map<String, byte[]> dictW, Map<String, Integer> fileCnt) {
        long totalSize = 0;
